...
class SubscriptionSettingsForm extends ConfigFormBase {
  ...
  public function submitForm(array &$form, array &$form_state) {
    $this->configFactory()->get('simplenews.settings')
      ...
      ->set('subscription.use_combined', $form_state['values']['simplenews_confirm_subscribe_subject'])
      ->set('subscription.confirm_subscribe_unsubscribed', $form_state['values']['simplenews_confirm_subscribe_unsubscribed'])
      ->set('subscription.confirm_subscribe_subscribed', $form_state['values']['simplenews_confirm_subscribe_subscribed'])
      ->set('subscription.confirm_unsubscribe_unsubscribed', $form_state['values']['simplenews_confirm_unsubscribe_subscribed'])
      ->set('subscription.confirm_unsubscribe_unsubscribed', $form_state['values']['simplenews_confirm_unsubscribe_unsubscribed'])
      ->set('subscription.confirm_combined_subject', $form_state['values']['simplenews_confirm_combined_subject'])
      ->set('subscription.confirm_combined_body', $form_state['values']['simplenews_confirm_combined_body'])
      ->set('subscription.combined_body_unchanged', $form_state['values']['simplenews_confirm_combined_body_unchanged'])
      ->set('subscription.confirm_combined_line_subscribe_unsubscribed', $form_state['values']['simplenews_confirm_combined_line_subscribe_unsubscribed'])
      ->set('subscription.confirm_combined_line_subscribe_subscribed', $form_state['values']['simplenews_confirm_combined_line_subscribe_subscribed'])
      ->set('subscription.confirm_combined_line_unsubscribe_subscribed', $form_state['values']['simplenews_confirm_combined_line_unsubscribe_subscribed'])
      ->set('subscription.confirm_combined_line_unsubscribe_unsubscribed', $form_state['values']['simplenews_confirm_combined_line_unsubscribe_unsubscribed'])
      ->set('subscription.confirm_subscribe_page', $form_state['values']['simplenews_confirm_subscribe_page'])
      ->set('subscription.confirm_unsubscribe_page', $form_state['values']['simplenews_confirm_unsubscribe_page'])
      ->save();
